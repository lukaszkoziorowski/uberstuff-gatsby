...
export const products = [
  ...
  {
    id: 10,
    name: "Black Genuine Card Holder",
    color: "black",
    price: "$29,00",
    img: slimWalletPath,
    desc:
